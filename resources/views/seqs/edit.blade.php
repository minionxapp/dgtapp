...
@section('title', 'Edit Seq')

@section('content_header')
    <h1 class="m-0 text-dark">Edit Seq</h1>
@stop

@section('content')
    <form action="{{ route('seqs.update', $seq) }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('seqname') is-invalid @enderror" id="seqname"
                                placeholder="seqname" name="seqname" value="{{ $seq->seqname ?? old('seqname') }}">
                            @error('seqname')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nilai') is-invalid @enderror" id="nilai"
                                placeholder="nilai" name="nilai" value="{{ $seq->nilai ?? old('nilai') }}">
                            @error('nilai')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tahun') is-invalid @enderror" id="tahun"
                                placeholder="tahun" name="tahun" value="{{ $seq->tahun ?? old('tahun') }}">
                            @error('tahun')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('seqvalue') is-invalid @enderror"
                                id="seqvalue" placeholder="seqvalue" name="seqvalue"
                                value="{{ $seq->seqvalue ?? old('seqvalue') }}">
                            @error('seqvalue')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                ...
                                value="{{ $seq->keterangan ?? old('keterangan') }}">
                            @error('keterangan')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
