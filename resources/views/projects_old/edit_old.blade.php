                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                name="nama" value="{{ $project->nama ?? old('nama') }}">
                            @error('nama')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="divisi_kode" class="form-control" id="divisi_kode">
                                ...
                                @foreach ($divisi_kodes as $divisi)
                                    @if ($divisi->kode == $project->divisi_kode)
                                        <option selected="selected" value={{ $divisi->kode }}>
                                            {{ $divisi->nama }}</option>
                                    @else
                            ...
                            <select name="unit_req" class="form-control" id="unit_req">
                                ...
                                @foreach ($unit_reqs as $unit_req)
                                    @if ($unit_req->kode == $project->kode)
                                        <option selected="selected" value={{ $unit_req->kode }}>{{ $unit_req->desc }}
                                        </option>
                                    @else
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="pic_req" name="pic_req" value="{{ $project->pic_req ?? old('pic_req') }}">
                            @error('pic_req')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="file01" name="file01" value="{{ $project->file01 ?? old('file01') }}">
                            @error('file01')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="file02" name="file02" value="{{ $project->file02 ?? old('file02') }}">
                            @error('file02')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="gambar" name="gambar" value="{{ $project->gambar ?? old('gambar') }}">
                            @error('gambar')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                            ...
                            <select name="divisi_assignto" class="form-control" id="divisi_assignto">
                                ...
                                @foreach ($divisi_assigntos as $divisi_assignto)
                                    @if ($divisi_assignto->kode == $project->kode)
                                        <option selected="selected" value={{ $divisi_assignto->kode }}>
                                            {{ $divisi_assignto->desc }}</option>
                                    @else
                            ...
                            <select name="dept_assignto" class="form-control" id="dept_assignto">
                                ...
                                @foreach ($dept_assigntos as $dept_assignto)
                                    @if ($dept_assignto->kode == $project->kode)
                                        <option selected="selected" value={{ $dept_assignto->kode }}>
                                            {{ $dept_assignto->desc }}</option>
                                    @else
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="file_desc01" name="file_desc01"
                                value="{{ $project->file_desc01 ?? old('file_desc01') }}">
                            @error('file_desc01')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="file_uri01" name="file_uri01"
                                value="{{ $project->file_uri01 ?? old('file_uri01') }}">
                            @error('file_uri01')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="file_desc02" name="file_desc02"
                                value="{{ $project->file_desc02 ?? old('file_desc02') }}">
                            @error('file_desc02')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                placeholder="file_uri02" name="file_uri02"
                                value="{{ $project->file_uri02 ?? old('file_uri02') }}">
                            @error('file_uri02')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                class="form-control @error('pic_assignto') is-invalid @enderror" id="pic_assignto"
                                placeholder="pic_assignto" name="pic_assignto"
